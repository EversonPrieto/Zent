...
export default function SignupPage() {
  ...
  return (
    <main className={`min-h-screen overflow-x-hidden ${themeClasses.bg.primary}`}>
      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl px-3 pt-4 sm:px-6 sm:pt-6 lg:px-8">
        <button
          type="button"
          onClick={handleBack}
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-64px)] max-w-6xl items-center justify-center px-3 py-6 sm:px-4 sm:py-10 md:px-6">
        <div
          className={`grid w-full max-w-5xl overflow-hidden rounded-3xl border ${themeClasses.border.primary} ${themeClasses.bg.primary} shadow-2xl backdrop-blur-sm animate-in fade-in slide-in-from-bottom-4 duration-500 lg:grid-cols-2`}
        >
          <div
          ...
          <div className="min-w-0 p-5 sm:p-6 md:p-8 lg:p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {success && (
                <div className="flex items-start gap-2 rounded-lg border border-emerald-500/20 bg-emerald-500/10 p-3 text-sm text-emerald-400 animate-in fade-in slide-in-from-top-1">
